...
class dataset():
    def __init__(self,file_path):
        ...
        self.train_label=self.y.iloc[0:1000].to_numpy()
        self.val_label=self.y.iloc[train_index:val_index].to_numpy()
